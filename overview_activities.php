							...
							<div class="12u 12u$(medium)">
								...
								<?php
									if(isset($_POST['date_range'])) {
										...
										$sql = "SELECT * FROM activities INNER JOIN users ON users.id = activities.user_id WHERE activities.created_at BETWEEN '$date1' AND '$date2'";
								...
								<?php
										...
										$sql = "SELECT * FROM activities INNER JOIN users ON users.id = activities.user_id";
										$query = $conn->query($sql);
